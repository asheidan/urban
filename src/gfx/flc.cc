...
struct flc_header {
	unsigned int size		__attribute__((packed));
        ...
        unsigned int speed		__attribute__((packed));
        short res0		__attribute__((packed));
        int c_time		__attribute__((packed));
        int res3		__attribute__((packed));
        int res4		__attribute__((packed));
        int res5		__attribute__((packed));
        short aspectx		__attribute__((packed));
        short aspecty		__attribute__((packed));
        char res[38]		__attribute__((packed));
        int oframe1		__attribute__((packed));
        int oframe2		__attribute__((packed));
